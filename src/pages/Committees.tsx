      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .ashe-bar {
            ...
            border-radius: 14px;
            transition: height 0.5s cubic-bezier(.4,0,.2,1), box-shadow 0.4s ease;
          }
          ...
          .ashe-bar-bg { filter: brightness(0.32) saturate(0.6) !important; transition: filter 0.5s ease, transform 0.5s ease !important; }
          .ashe-bar.active .ashe-bar-bg { filter: brightness(0.45) saturate(0.9) !important; transform: scale(1.04) !important; }
          .ashe-bar-gradient { transition: opacity 0.4s !important; }
          ...
          .ashe-expanded {
            ...
            transition: opacity 0.38s 0.1s ease, transform 0.38s 0.1s ease !important;
